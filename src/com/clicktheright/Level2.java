...
public class Level2 extends Activity implements OnClickListener{
   	  ...
   	  if((id-12) == result1 || (id-12) == result2 ){
   		...
   		Log.d("num", "num"+ sequence);
   		  ...
   		  {	
   			...
   			vb.vibrate(500);
   			  mp = MediaPlayer.create(Level2.this, R.raw.succ2);
   		mp.start();
   		...
   		handler.postDelayed(new Runnable() {
   		  ...
   		  public void run() {
   			...
   			if(screenCounter>8){
   				Intent i = new Intent(Level2.this, SelectLevel.class);
   				startActivity(i);
   				finish();
    ...
    private void playmusic(int i) {
		...
		if(i==0)
		{
			mp = MediaPlayer.create(Level2.this, R.raw.err);
		}
		else 
		{
			mp = MediaPlayer.create(Level2.this, R.raw.succ1);
		}
