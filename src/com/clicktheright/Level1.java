...
public class Level1 extends Activity implements OnClickListener{
	...
	Integer[] letters;
	List<String> questions =new ArrayList<String>(26);
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		question.setText(questions.get(screenCounter));
	...
	public void onClick(View v){
		...
		if((id-12) == result1 || (id-12) == result2 )
		{
			...
			{	
				...
				vb.vibrate(500);
				mp = MediaPlayer.create(Level1.this, R.raw.succ2);
				mp.start();
				...
				handler.postDelayed(new Runnable() {
					...
					public void run() {
						...
						if(screenCounter>10){
							Intent intent = new Intent(Level1.this, SelectLevel.class);
	...
	private void playmusic(int i) {
		...
		if(i==0)
		{
			mp = MediaPlayer.create(Level1.this, R.raw.err);
		}
		else 
		{
			mp = MediaPlayer.create(Level1.this, R.raw.succ1);
		}
	...
	private void set_ans_choice() {
		...
		options_temp.add(questions.get(screenCounter));
		options_temp.add(symbols.get(1));
		options_temp.add(symbols.get(2));
		options_temp.add(symbols.get(3));
		options_temp.add(symbols.get(4));
		options_temp.add(symbols.get(5));
		...
		options_temp.add(questions.get(screenCounter));
		options_temp.add(symbols.get(6));
		options_temp.add(symbols.get(7));
		options_temp.add(symbols.get(8));
		options_temp.add(symbols.get(9));
		options_temp.add(symbols.get(10));
